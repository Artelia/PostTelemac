...
class Bessel(CtrlNode):
    ...
    uiTemplate = [
        ...
        (
            "cutoff",
            "spin",
            {"value": 1000.0, "step": 1, "dec": True, "range": [0.0, None], "suffix": "Hz", "siPrefix": True},
        ),
...
class Butterworth(CtrlNode):
    ...
    uiTemplate = [
        ...
        (
            "wStop",
            "spin",
            {"value": 2000.0, "step": 1, "dec": True, "range": [0.0, None], "suffix": "Hz", "siPrefix": True},
        ),
        (
            "gPass",
            "spin",
    ...
    def processData(self, data):
        ...
        if s["band"] == "lowpass":
            ...
            mode = "high"
        ret = functions.butterworthFilter(
            data, bidir=s["bidir"], btype=mode, wPass=s["wPass"], wStop=s["wStop"], gPass=s["gPass"], gStop=s["gStop"]
        )
        return ret
...
class ButterworthNotch(CtrlNode):
    ...
    uiTemplate = [
        ...
        (
            "high_wPass",
            "spin",
            {"value": 3000.0, "step": 1, "dec": True, "range": [0.0, None], "suffix": "Hz", "siPrefix": True},
        ),
        (
            "high_wStop",
            "spin",
            {"value": 4000.0, "step": 1, "dec": True, "range": [0.0, None], "suffix": "Hz", "siPrefix": True},
        ),
        (
            "high_gPass",
            "spin",
    ...
    def processData(self, data):
        ...
        low = functions.butterworthFilter(
            data,
            bidir=s["bidir"],
            btype="low",
            wPass=s["low_wPass"],
        ...
        high = functions.butterworthFilter(
            data,
            bidir=s["bidir"],
            btype="high",
            wPass=s["high_wPass"],
