...
if (
    __version__ is None and not hasattr(sys, "frozen") and sys.version_info[0] == 2
):  ## If we are frozen, there's a good chance we don't have the original .py files anymore.
    renamePyc(path)
