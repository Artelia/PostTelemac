...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.visibleOnlyCheck.setToolTip(
            QtGui.QApplication.translate(
                "Form",
