...
class GraphicsItem(object):
    ...
    **Bases:** :class:`object`
    ...
    def deviceTransform(self, viewportTransform=None):
        ...
        """
        if (
            self._exportOpts is not False and "painter" in self._exportOpts
        ):  ## currently exporting; device transform may be different.
    ...
    def _updateView(self):
        ...
        if oldView is not None:
            for signal, slot in [
                ("sigRangeChanged", self.viewRangeChanged),
