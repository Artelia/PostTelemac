                ...
                if METHOD == 0:  # Method0 : shortest path and vector computation
                    ...
                    for line in temp3:
                        ...
                        for points in range(len(linetemp) - 1):
                            try:
                                triangle = self.selafinlayer.hydrauparser.trifind.__call__(
                                ...
                                if True:
                                    if i == 0:  # init
                                        try:
                                            h2 = np.array(
                                                self.selafinlayer.hydrauparser.getTimeSerie(
                                                    [elem + 1], [parameterh], self.selafinlayer.hydrauparser.parametres
                                                )[0][0]
                                            )
                                        except Exception, e:
                                        ...
                                        uv2 = np.array(
                                            self.selafinlayer.hydrauparser.getTimeSerie(
                                                [elem + 1], [parameteruv], self.selafinlayer.hydrauparser.parametres
                                            )[0][0]
                                        )
                                        uv2 = np.array([[value, 0.0] for value in uv2])
                                        vv2 = np.array(
                                            self.selafinlayer.hydrauparser.getTimeSerie(
                                                [elem + 1], [parametervv], self.selafinlayer.hydrauparser.parametres
                                            )[0][0]
                                        )
