    ...
    def image(self, values, imageSize, center, mapUnitsPerPixel, rotation=0):
        ...
        try:
            ...
            if True:
                ...
                # scale
                glScalef(
                    2.0 / (roundupSz.width() * mapUnitsPerPixel[0]), 2.0 / (roundupSz.height() * mapUnitsPerPixel[1]), 1
                )
                # rotate
            ...
            return img.copy(
                0.5 * (roundupSz.width() - imageSize.width()),
                0.5 * (roundupSz.height() - imageSize.height()),
                imageSize.width(),
                imageSize.height(),
            )
        except Exception as e:
