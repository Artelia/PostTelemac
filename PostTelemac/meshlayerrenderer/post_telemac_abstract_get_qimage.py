        ...
        if False:
            ...
            if True:
                if direction:
                    ...
                    x, y, z = self.meshlayer.xform.transformCoords(lencoords,xcoordsfinal, ycoordsfinal, zcoordsfinal,qgis.core.QgsCoordinateTransform.ReverseTransform )
            if False:
                if direction:
                    self.meshlayer.xform.transformInPlace(xcoordsfinal, ycoordsfinal, zcoordsfinal )
                else:
                    self.meshlayer.xform.transformInPlace( xcoordsfinal, ycoordsfinal, zcoordsfinal,qgis.core.QgsCoordinateTransform.ReverseTransform )
            if False:
                if direction:
